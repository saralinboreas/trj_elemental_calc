export const ELEMENTS = [
  ...
  { id: 'ElementDiscipline', name: 'Disciplina', category: 'Especial', color: '#680D22', icon: '?' },
...
export const OVERRIDES = {
  ...
  ElementDegradation: {
    ElementDegradation: 0,
    ElementPenance: 4,
    ElementTempus: 2,
    ElementAnnihilation: 0.5,
    ElementElectruid: 8,
    ElementFire: 4,
    ElementWater: 4,
    ElementEnergy: 4,
  ...
  ElementAnnihilation: {
    ElementAnnihilation: 8,
    ElementDegradation: 2,
    ElementPenance: 4,
    ElementTempus: 0.5,
    ElementElectruid: 8,
    ElementBlood: 2,
  ...
  ElementTempus: {
    ElementTempus: 0,
    ElementPenance: 1.5,
    ElementAnnihilation: 2,
    ElementDegradation: 0.5,
    ElementElectruid: 8,
    ElementBlood: 2,
    ElementGenesis: 4,
    ElementRupture: 4
  ...
  ElementBlood: {
    ...
    ElementElectruid: 1,
    ElementTempus: 0.5,
    ElementAnnihilation: 0.2,
  },
  
  ElementDiscipline: {
    ElementBlood: 1,
    ElementAnnihilation: 1,
    ElementGenesis: 1,
    ElementRupture: 1,
