...
export const OVERRIDES = {
  ElementPenance: { ElementPenance: 0, ElementLight: 2, ElementVoid: 2, ElementChaos: 2, ElementAir: 1.5, ElementElectruid: 8 },
  ElementDegradation: { ElementDegradation: 0, ElementPenance: 4, ElementTempus: 2, ElementAnnihilation: 0.5, ElementElectruid: 8 },
  ElementAnnihilation: { ElementAnnihilation: 8, ElementDegradation: 2, ElementPenance: 4, ElementTempus: 0.5, ElementElectruid: 8, ElementBlood: 2, ElementGenesis: 8, ElementRupture: 8 },
  ElementTempus: { ElementTempus: 0, ElementPenance: 1.5, ElementAnnihilation: 2, ElementDegradation: 0.5, ElementElectruid: 8 },
  ...
  ElementGenesis: { ElementGenesis: 0, ElementRupture: 2 },
  ElementRupture: { ElementRupture: 0, ElementGenesis: 2 },
  ...
  ElementFire: { ElementFire: 0, ElementAir: 2, ElementIce: 2, ElementTerra: 2, ElementWater: 0.5, ElementElectruid: 0.5 },
  ElementWater: { ElementElectruid: 0, ElementWater: 0, ElementFire: 2, ElementTerra: 1.5, ElementEnergy: 0.5, ElementIce: 0.75 },
  ElementIce: { ElementIce: 0, ElementWater: 1.5, ElementAir: 1.5, ElementEnergy: 0.5, ElementFire: 0.5, ElementElectruid: 0.5 },
  ElementEnergy: { ElementElectruid: 0, ElementEnergy: 0, ElementWater: 2, ElementIce: 2, ElementAir: 1.5, ElementTerra: 0.5 },
  ElementTerra: { ElementTerra: 0, ElementEnergy: 2, ElementElectruid: 1.5, ElementAir: 1.5, ElementFire: 0.5, ElementWater: 0.75 },
  ElementAir: { ElementAir: 0, ElementTerra: 1.5, ElementFire: 1.5, ElementPenance: 1.5, ElementIce: 0.75, ElementEnergy: 0.75 }
};
